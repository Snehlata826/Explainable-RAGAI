"""
Central configuration for GenAI RAG Copilot — Production Grade.
...
for d in [DATA_DIR, FAISS_INDEX_DIR, FEEDBACK_DIR, EVAL_DIR, LOG_DIR]:
...
LLM_TEMPERATURE: float = float(os.getenv("LLM_TEMPERATURE", "0.1"))  # lower = less hallucination
...
# ── Evaluation ─────────────────────────────────────────────────────────────
GROUNDEDNESS_THRESHOLD: float = 0.15   # below this = flag as hallucination
EVAL_LOGGING: bool = os.getenv("EVAL_LOGGING", "true").lower() == "true"